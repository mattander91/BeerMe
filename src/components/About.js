...
const About = () => (
  <div>
    ...
    <div className="about">
      <p style={{'font-size': '25px'}}>Beer Me</p>
      <p>Beer Me allows you keep track of beers you have tried and wishlist of beers you can only dream about trying. Beer Me is powered by <a style={{'color': 'white', 'text-decoration': 'underline'}} href="http://www.brewerydb.com/" target="_blank">Brewery DB</a> which contains an extensive database of beer and brewery related info for almost any beer you can think of.
      </p>
      <p style={{'font-size': '25px'}}>How to use</p>
